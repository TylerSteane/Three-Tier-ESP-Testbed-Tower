# |**********************************************************************;
# * Project           : ESP Testbed Tower - Client.
# *
# * Program name      : Pi_Client.py
# *
# * Author            : Michael Trifilo
# *
# * Date created      : 16-10-2018
# *
# * Purpose           : Client script to sun on Raspberry Pi on each testbed tower, flash esp devices using serial pins and multiplex selection pins.
# *
# * Dependencies      : RPi.GPIO
# *
# * Usage			  : python Pi_Client.py -mgmt_PC IP address e.g.: 'python Pi_Client.py 192.168.0.100'
# *
# * Revision History  :
# *
# * Date        Author      Ref    Revision
# * 16-10-2018  M Trifilo    1      Initial implementation
# *
# |**********************************************************************;
import platform
